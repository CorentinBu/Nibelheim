...
public class Dimensions {
    ...
    private static final int REFERENCE_WIDTH = 1155;
    private static final int REFERENCE_HEIGHT = 650;
    
    // Facteurs d'échelle actuels
    private static float scaleX_ratio = 1.0f;
    private static float scaleY_ratio = 1.0f;
    ...
    public static void updateDimensions(int width, int height) {
        ...
        scaleX_ratio = (float) width / REFERENCE_WIDTH;
        scaleY_ratio = (float) height / REFERENCE_HEIGHT;
    }
    ...
    public static float getMinScale() {
        return Math.min(scaleX_ratio, scaleY_ratio);
    }
    ...
    // getScaleX et getScaleY sont des méthodes d'accès pour les facteurs d'échelle
