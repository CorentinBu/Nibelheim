...
public class Goules extends Ennemies {
   ...
   // Taille de la fenêtre de jeu pour gerer la position de l'ennemi
    ...
    // Image de l'ennemie
    public static final Image sprite = new ImageIcon("src/Images/araignee2.gif").getImage().getScaledInstance(width,
    ...
    public void goToCharacter() {
       ...
       // System.out.println("Position de la goule : " + goulePosition.x + " " + goulePosition.y);
        ...
        if (distance > 0) {
            ...
            //on verifie si la distance entre le joueur et la goule est superieur ou égale a DISTANCE_MAX_X et DISTANCE_MAX_Y
    ...
    public void TirGoule(Point goulePosition, double directionX, double directionY) {
        ...
        if (projectile == null) {
            ...
            projectile = new Projectile(new Point(goulePosition.x, goulePosition.y), new Point((int)directionX,(int) directionY));
