...
public class Affichage extends JPanel {
    ...
    private Bouton buyCombo1 = new Bouton("Buy 50p", X / 2 - 225, Y / 2 - 95, 90, 22, 
        new Color(96,96,96), Color.WHITE, new Color(70, 130, 180), null, 14);
    private Bouton buyCombo2 = new Bouton("Buy 75p", X / 2 - 50, Y / 2 - 95, 90, 22, 
         new Color(96,96,96), Color.WHITE, new Color(70, 130, 180), null, 14);
    private Bouton buyCombo3 = new Bouton("Buy 90p", X / 2 + 125, Y / 2 - 95, 90, 22, 
        new Color(96,96,96), Color.WHITE, new Color(70, 130, 180), null, 14);
    ...
    // Images (initialisées dans initImages() pour éviter des NullPointer lors de la création)
